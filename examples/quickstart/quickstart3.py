...
async def main():
    ...
    try:
        ...
        episodes = [
            {
                'content': "Sprintsolo is a software development company based in Seoul, South Korea. They operate in the Software Development industry and currently have 3 employees. The company specializes in developing AI agent solutions for startups.",
                'type': EpisodeType.text,
                'description': 'Company information',
            },

            {
                'content': "Sihyun Hwang works at Sprintsolo as a developer. His email address is simon@sprintsolo.com.",
                'type': EpisodeType.text,
                'description': 'Contact information',
            },

            {
                'content': "Hyungu Kim is the CEO of Sprintsolo. His email address is first@sprintsolo.com.",
                'type': EpisodeType.text,
                'description': 'Contact information',
            }
        ]
        ...
        for i, episode in enumerate(episodes):
            await graphiti.add_episode(
                name=f'Contact Info {i}',
                episode_body=episode['content']
                if isinstance(episode['content'], str)
                else json.dumps(episode['content'],ensure_ascii=False),
                source=episode['type'],
        ...
        print("\nSearching for: 'Who works in sprintsolo?'")
        results = await graphiti.search('Who works in sprintsolo?')
